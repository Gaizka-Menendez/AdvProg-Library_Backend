...
class Film_DB(Base, Library_Item):
    ...
    genres = relationship("Genre_DB", secondary="film_genre_association", back_populates="films")
...
class Book_DB(Base, Library_Item):
    ...
    genres = relationship("Genre_DB", secondary="book_genre_association", back_populates="books")
...
class Genre_DB(Base):
    ...
    books = relationship("Book_DB", secondary="book_genre_association", back_populates="genres")
    films = relationship("Film_DB", secondary="film_genre_association", back_populates="genres")
